    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                JSONObject json = sr.getJSON("http://192.168.221.22:8080/login",params);
            ...
            public void onClick(View view) {
                ...
                cont.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        JSONObject json = sr.getJSON("http://192.168.221.22:8080/api/resetpass", params);
                                ...
                                cont_code.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                     ...
                                     //   JSONObject json = sr.getJSON("http://10.0.2.2:8080/api/resetpass/chg", params);
                                        JSONObject json = sr.getJSON("http://192.168.221.22:8080/api/resetpass/chg", params);
